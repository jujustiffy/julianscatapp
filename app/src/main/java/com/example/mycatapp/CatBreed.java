...
public class CatBreed {
    ...
    public void setSuppressed_tail (String suppressed_tail) { this.suppressed_tail = suppressed_tail; }
    ...
    public void setVcahospitals_url (String vcahospitals_url) { this.vcahospitals_url = vcahospitals_url; }
    ...
    public void setStranger_friendly (String stranger_friendly) { this.stranger_friendly = stranger_friendly; }
    ...
    public void setAffection_level (String affection_level) { this.affection_level = affection_level; }
